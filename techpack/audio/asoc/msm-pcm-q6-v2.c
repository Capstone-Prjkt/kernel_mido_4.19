...
#if (defined CONFIG_MACH_XIAOMI_MIDO) || (defined CONFIG_MACH_XIAOMI_D2) || (defined CONFIG_MACH_XIAOMI_TISSOT)
...
#if (defined CONFIG_MACH_XIAOMI_MIDO) || (defined CONFIG_MACH_XIAOMI_D2) || (config CONFIG_MACH_XIAOMI_TISSOT)
